...
# score multiplied by 10.  reward +1 for staying alive.  
        ...
        for e in range(EPOCHS):
            with tf.GradientTape(persistent=True, watch_accessed_variables=False) as tape:
                ...
                while not done:  # get params for one episode.
                    ...
                    next_state, score, _, info = env.step(action)
                    ...
                    #for m in range(4):
                        ...
                        #im = Image.fromarray( state_array[0,:,:,m] )
                        #im.save("C:/my_working_env/deeplearning_practice/test/image" + str(num_run) + str(m) + ".jpeg")
                    ...
                    reward = score*10. + 1.   # +1 reward for staying alive.  
                ...
                if self.id==0:
                    ...
                    if e%10==0:  print( self.local_model(state)[0] )
